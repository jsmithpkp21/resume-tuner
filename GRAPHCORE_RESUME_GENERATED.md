...
- Refactored legacy error handling that swallowed I/O exceptions (`null`/`false`), enforcing fail-fast behavior at the point of failure and improving API retry/priority handling; improved overall test pass rate by 5 percent or less and reduced random hard-to-reproduce failures by 40 percent.
...
Led technical evaluation and design discussions for integrating multiple product groups into a shared corporate automation architecture.

Related skills: Architecture, Framework Design, Technical Leadership, Java, JUnit 5, Developer Tooling, CI/CD, Dependency Management, Versioning automation
...
Provided senior-level architectural guidance and technical design leadership for a cross-organization automation initiative.

Related skills: Architecture, Automation Strategy, Java, JUnit 4, Prototype Design, Framework Design, Technical Leadership

- Evaluated migration paths for unifying automation across 3 organizations (Video, Audio, Network), improving alignment on a shared framework strategy.
- Built exploratory prototypes and design evaluations that informed cross-team architecture decisions and feasibility tradeoffs, reducing duplicate framework spike efforts by 40 percent across participating teams.
- Conducted framework assessments across 3 product organizations and at least 8 test groups, identifying gaps and unifying database/control patterns; assessments directly informed subsequent team migrations to a unified framework approach, improving migration readiness and driving modularization of REST/third-party control logic into reusable Java libraries.

### Lead Framework Designer, Video SQA Automation | HP / Poly
2008-08 - 2018-03

Principal architect and long-term technical steward of the Video SQA automation framework.

Related skills: Technical Leadership, Java, JUnit 4, JUnit 5, Mentoring, Process Design, Capability-Driven Design, UI & Model-Agnostic Abstractions, Framework Design, CI/CD, Test reliability engineering, Distributed Execution, REST/SOAP Integration, Telnet/CLI Automation, Web UI Automation

- Provided technical leadership for a distributed group of 15 engineers across four countries and five time zones, improving engineering quality and reducing new-test creation time by 30 percent.
- Designed a capability-driven framework architecture with UI-agnostic flows and shared model normalization across SOAP/REST and product variants, improving cross-product portability across hardware generations and 16 endpoint models.
...
- **CFO & Board Member, Cat Rescue | QA and Test Automation Communities | 2009-Present**
  - Co-manage finances, operations, and long term planning for a 15-year nonprofit rescue, enabling growth from 15-20 cats to a peak of 60.
- **Phi Kappa Psi Fraternity | Philanthropy Chair**
  - Organized fundraising and community service events.
