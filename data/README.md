...
- `profile/profile.toml`: baseline resume profile data (name/contact/summary plus education and leadership/community sections)
  ...
  - Optional local override: `profile/profile.local.toml` can provide personal contact fields (`name`, `location`, `email`, `phone`, `website`, `linkedin`, `github`) without committing them.
