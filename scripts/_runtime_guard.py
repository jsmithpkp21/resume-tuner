...
``from scripts._runtime_guard import X`` (including underscore-prefixed back-compat
...
# so `import resume_builder._runtime_guard` resolves whether the package is installed
...
import resume_builder._runtime_guard as _impl  # noqa: E402
...
# namespace so legacy callers (`from scripts._runtime_guard import _private`) and
