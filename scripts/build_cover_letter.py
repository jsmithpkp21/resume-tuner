...
``from scripts.build_cover_letter import X`` (including underscore-prefixed back-compat
aliases) working and preserves the ``python scripts/build_cover_letter.py`` CLI entry.
"""

from __future__ import annotations

# CI venvs don't always run `pip install -e .`; bootstrap src/ onto sys.path
# so `import resume_builder.build_cover_letter` resolves whether the package is installed
...
import resume_builder.build_cover_letter as _impl  # noqa: E402
from resume_builder.build_cover_letter import *  # noqa: E402, F401, F403
from resume_builder.build_cover_letter import main  # noqa: E402

# `import *` skips underscore-prefixed names; copy the full implementation
# namespace so legacy callers (`from scripts.build_cover_letter import _private`) and
