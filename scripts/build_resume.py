...
# so `from resume_builder.build_resume import *` resolves whether the package is
...
from resume_builder.build_resume import (  # noqa: E402 — explicit re-export for CLI dispatch
    main,
)
