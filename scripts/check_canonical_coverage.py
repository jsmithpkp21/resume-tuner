...
# so `from resume_builder.check_canonical_coverage import *` resolves whether the package is
...
from resume_builder.check_canonical_coverage import (  # noqa: E402 — explicit re-export for CLI dispatch
    main,
)
