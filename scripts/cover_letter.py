...
``from scripts.cover_letter import X`` (including underscore-prefixed back-compat
...
# so `import resume_builder.cover_letter` resolves whether the package is installed
...
import resume_builder.cover_letter as _impl  # noqa: E402
from resume_builder.cover_letter import *  # noqa: E402, F401, F403

# `import *` skips underscore-prefixed names; copy the full implementation
# namespace so legacy callers (`from scripts.cover_letter import _private`) and
