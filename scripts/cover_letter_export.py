...
``from scripts.cover_letter_export import X`` (including underscore-prefixed back-compat
...
# so `import resume_builder.cover_letter_export` resolves whether the package is installed
...
import resume_builder.cover_letter_export as _impl  # noqa: E402
from resume_builder.cover_letter_export import *  # noqa: E402, F401, F403

# `import *` skips underscore-prefixed names; copy the full implementation
# namespace so legacy callers (`from scripts.cover_letter_export import _private`) and
