...
``from scripts.cover_letter_template import X`` (including underscore-prefixed back-compat
...
# so `import resume_builder.cover_letter_template` resolves whether the package is installed
...
import resume_builder.cover_letter_template as _impl  # noqa: E402
...
# namespace so legacy callers (`from scripts.cover_letter_template import _private`) and
