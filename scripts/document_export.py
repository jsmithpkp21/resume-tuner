...
``from scripts.document_export import X`` (including underscore-prefixed back-compat
...
# so `import resume_builder.document_export` resolves whether the package is installed
...
import resume_builder.document_export as _impl  # noqa: E402
...
# namespace so legacy callers (`from scripts.document_export import _private`) and
