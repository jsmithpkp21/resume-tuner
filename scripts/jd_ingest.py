...
``from scripts.jd_ingest import X`` (including underscore-prefixed back-compat
...
# so `import resume_builder.jd_ingest` resolves whether the package is installed
...
import resume_builder.jd_ingest as _impl  # noqa: E402
from resume_builder.jd_ingest import *  # noqa: E402, F401, F403

# `import *` skips underscore-prefixed names; copy the full implementation
# namespace so legacy callers (`from scripts.jd_ingest import _private`) and
