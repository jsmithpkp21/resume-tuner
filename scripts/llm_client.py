...
``from scripts.llm_client import X`` (including underscore-prefixed back-compat
...
# so `import resume_builder.llm_client` resolves whether the package is installed
...
import resume_builder.llm_client as _impl  # noqa: E402
...
# namespace so legacy callers (`from scripts.llm_client import _private`) and
