...
# so `from resume_builder.measure_skills_lines import *` resolves whether the package is
...
from resume_builder.measure_skills_lines import (  # noqa: E402 — explicit re-export for CLI dispatch
    main,
)
