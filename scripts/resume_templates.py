...
``from scripts.resume_templates import X`` (including underscore-prefixed back-compat
...
# so `import resume_builder.resume_templates` resolves whether the package is installed
...
import resume_builder.resume_templates as _impl  # noqa: E402
from resume_builder.resume_templates import *  # noqa: E402, F401, F403

# `import *` skips underscore-prefixed names; copy the full implementation
# namespace so legacy callers (`from scripts.resume_templates import _private`) and
