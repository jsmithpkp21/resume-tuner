...
``from scripts.select_skills import X`` (including underscore-prefixed back-compat
...
# so `import resume_builder.select_skills` resolves whether the package is installed
...
import resume_builder.select_skills as _impl  # noqa: E402
...
# namespace so legacy callers (`from scripts.select_skills import _private`) and
